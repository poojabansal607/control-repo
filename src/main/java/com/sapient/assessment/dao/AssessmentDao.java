...
public interface AssessmentDao {
	...
	@SqlQuery("select rv.question_id from response_value as rv INNER JOIN "+
" (select rd.response_id from response_details as rd INNER JOIN " + 
" assessment on rd.test_id=assessment.test_id and assessment.project_id = :project_key) "+ 
" as filter_response on rv.response_id=filter_response.response_id; ")
	@Mapper(ResponseMapper.class)
	List<Question> getCheckedQuestion(@Bind("project_key") long project_key);
