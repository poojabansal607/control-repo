...
public interface RegisterDAO {
	...
	void saveClient(@Bind("clientName") String clientName, @Bind("userNames") String userName,
			@Bind("password") String password, @Bind("email") String email);

	@SqlQuery("select count(email) from client_details as c where c.email= :emailId")
	long getemail(@Bind("emailId") String emailId);
}
